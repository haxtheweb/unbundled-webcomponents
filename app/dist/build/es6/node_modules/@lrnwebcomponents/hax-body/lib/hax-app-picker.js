import{LitElement,html,css}from"../../../lit-element/lit-element.js";class HaxAppPicker extends LitElement{static get styles(){return[css`
        :host {
          display: block;
        }
      ...
      `]}constructor(){super(),this._elements=[],this.selectionList=[],this.title="Pick an options",this.pickerType="gizmo",this.opened=!1,import("../../../@polymer/paper-button/paper-button.js"),import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/paper-dialog/paper-dialog.js"),setTimeout(()=>{this.addEventListener("iron-overlay-canceled",this.close.bind(this)),this.addEventListener("iron-overlay-closed",this.close.bind(this))},0)}render(){return html`
