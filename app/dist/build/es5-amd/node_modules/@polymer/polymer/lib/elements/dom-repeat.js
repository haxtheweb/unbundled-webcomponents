...
get:function get(){return"dom-repeat"}},{key:"template",get:function get(){return null}},{key:"properties",get:function get(){/**
     ...
     */return{/**
       ...
       */reuseChunkedInstances:{type:Boolean}}}},{key:"observers",get:function get(){return["__itemsChanged(items.*)"]}}]);function DomRepeat(){var _this;babelHelpers.classCallCheck(this,DomRepeat);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomRepeat).call(this));_this.__instances=[];_this.__renderDebouncer=null;_this.__itemsIdxToInstIdx={};_this.__chunkCount=null;_this.__renderStartTime=null;_this.__itemsArrayChanged=!1;_this.__shouldMeasureChunk=!1;_this.__shouldContinueChunking=!1;_this.__chunkingId=0;_this.__sortFn=null;_this.__filterFn=null;_this.__observePaths=null;/** @type {?function(new:TemplateInstanceBase, Object=)} */_this.__ctor=null;_this.__isDetached=!0;_this.template=null;/** @type {TemplateInfo} */_this._templateInfo;return _this}/**
   * @override
   * @return {void}
...
for(var paths=this.__observePaths,i=0;i<paths.length;i++){if(0===path.indexOf(paths[i])){this.__debounceRender(this.__render,this.delay)}}}}}},{key:"__itemsChanged",value:function __itemsChanged(change){if(this.items&&!Array.isArray(this.items)){console.warn("dom-repeat expected array for `items`, found",this.items)}// If path was to an item (e.g. 'items.3' or 'items.3.foo'), forward the
...
this.__debounceRender(this.__render);(0,_flush.flush)()}},{key:"__render",value:function __render(){var _this3=this;if(!this.__ensureTemplatized()){// No template found yet
...
if(this.initialCount&&(this.__shouldMeasureChunk||this.__shouldContinueChunking)){cancelAnimationFrame(this.__chunkingId);this.__chunkingId=requestAnimationFrame(function(){return _this3.__continueChunking()})}// Set rendered item count
this._setRenderedItemCount(this.__instances.length);// Notify users
if(!_settings.suppressTemplateNotifications||this.notifyDomChange){this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}},{key:"__sortAndFilterItems",value:function __sortAndFilterItems(items){for(var _this4=this,isntIdxToItemsIdx=Array(items.length),i=0;i<items.length;i++){isntIdxToItemsIdx[i]=i}// Apply user filter
...
if(this.__sortFn){isntIdxToItemsIdx.sort(function(a,b){return _this4.__sortFn(items[a],items[b])})}return isntIdxToItemsIdx}},{key:"__calculateLimit",value:function __calculateLimit(filteredItemCount){var limit=filteredItemCount,currentCount=this.__instances.length;// When chunking, we increase the limit from the currently rendered count
