 ...
 */var DisableUpgradeMixin=(0,_mixin.dedupingMixin)(function(base){/**
   ...
   * @extends {HTMLElement}
   * @private
   */var superClass=(0,_elementMixin.ElementMixin)(base),observedAttributesGetter=findObservedAttributesGetter(superClass),DisableUpgradeClass=/*#__PURE__*/function(_superClass){babelHelpers.inherits(DisableUpgradeClass,_superClass);function DisableUpgradeClass(){var _this;babelHelpers.classCallCheck(this,DisableUpgradeClass);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DisableUpgradeClass).call(this));/** @type {boolean|undefined} */_this.__isUpgradeDisabled;return _this}babelHelpers.createClass(DisableUpgradeClass,[{key:"_initializeProperties",// Prevent element from initializing properties when it's upgrade disabled.
...
if(this.__isUpgradeDisabled&&null==value){babelHelpers.get(babelHelpers.getPrototypeOf(DisableUpgradeClass.prototype),"_initializeProperties",this).call(this);this.__isUpgradeDisabled=!1;if((0,_wrap.wrap)(this).isConnected){babelHelpers.get(babelHelpers.getPrototypeOf(DisableUpgradeClass.prototype),"connectedCallback",this).call(this)}}}else{babelHelpers.get(babelHelpers.getPrototypeOf(DisableUpgradeClass.prototype),"attributeChangedCallback",this).call(this,name,old,value,/** @type {null|string} */namespace)}}// Prevent element from connecting when it's upgrade disabled.
...
return DisableUpgradeClass});_exports.DisableUpgradeMixin=DisableUpgradeMixin});