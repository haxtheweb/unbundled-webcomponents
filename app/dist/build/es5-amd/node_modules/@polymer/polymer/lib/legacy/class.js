 ...
 */function mergeProperties(target,source){for(var p in source){var targetInfo=target[p],sourceInfo=source[p];if(!("value"in sourceInfo)&&targetInfo&&"value"in targetInfo){target[p]=Object.assign({value:targetInfo.value},sourceInfo)}else{target[p]=sourceInfo}}}var LegacyElement=(0,_legacyElementMixin.LegacyElementMixin)(HTMLElement);/* Note about construction and extension of legacy classes.
