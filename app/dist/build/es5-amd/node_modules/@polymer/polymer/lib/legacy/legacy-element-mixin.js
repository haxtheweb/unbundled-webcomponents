...
*/var DISABLED_ATTR="disable-upgrade",styleInterface=window.ShadyCSS,LegacyElementMixin=(0,_mixin.dedupingMixin)(function(base){// TODO(kschaaf): Note, the `@implements {Polymer_DirMixin}` is required here
...
/**
   ...
   * @extends {HTMLElement}
   * @private
   */var GesturesElement=(0,_gestureEventListeners.GestureEventListeners)((0,_elementMixin.ElementMixin)(base)),legacyElementBase=_elementMixin.builtCSS?GesturesElement:(0,_dirMixin.DirMixin)(GesturesElement),observedAttributesGetter=(0,_disableUpgradeMixin.findObservedAttributesGetter)(legacyElementBase),DIRECTION_MAP={x:"pan-x",y:"pan-y",none:"none",all:"auto"},LegacyElement=/*#__PURE__*/function(_legacyElementBase){babelHelpers.inherits(LegacyElement,_legacyElementBase);function LegacyElement(){var _this;babelHelpers.classCallCheck(this,LegacyElement);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LegacyElement).call(this));/** @type {boolean} */_this.isAttached;/** @type {?WeakMap<!Element, !Object<string, !Function>>} */_this.__boundListeners;/** @type {?Object<string, ?Function>} */_this._debouncers;// NOTE: Inlined for perf from version of DisableUpgradeMixin.
/** @type {boolean|undefined} */_this.__isUpgradeDisabled;/** @type {boolean|undefined} */_this.__needsAttributesAtConnected;/** @type {boolean|undefined} */_this._legacyForceObservedAttributes;return _this}/**
     ...
     * @return {void}
     */},{key:"__attributeReaction",value:function __attributeReaction(name,old,value){if(this.__dataAttributes&&this.__dataAttributes[name]||name===DISABLED_ATTR){this.attributeChangedCallback(name,old,value,null)}}/**
     ...
     */},{key:"setAttribute",value:function setAttribute(name,value){if(_settings.legacyNoObservedAttributes&&!this._legacyForceObservedAttributes){var oldValue=this.getAttribute(name);babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"setAttribute",this).call(this,name,value);// value coerced to String for closure's benefit
this.__attributeReaction(name,oldValue,value+"")}else{babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"setAttribute",this).call(this,name,value)}}/**
     ...
     */},{key:"removeAttribute",value:function removeAttribute(name){if(_settings.legacyNoObservedAttributes&&!this._legacyForceObservedAttributes){var oldValue=this.getAttribute(name);babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"removeAttribute",this).call(this,name);this.__attributeReaction(name,oldValue,null)}else{babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"removeAttribute",this).call(this,name)}}// NOTE: Inlined for perf from version of DisableUpgradeMixin.
...
if(this.__isUpgradeDisabled&&null==value){this._initializeProperties();this.__isUpgradeDisabled=!1;if((0,_wrap.wrap)(this).isConnected){this.connectedCallback()}}}else{babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"attributeChangedCallback",this).call(this,name,old,value,namespace);this.attributeChanged(name,old,value)}}}/**
...
if(_settings.legacyOptimizations&&this.hasAttribute(DISABLED_ATTR)){this.__isUpgradeDisabled=!0}else{var proto=Object.getPrototypeOf(this);if(!proto.hasOwnProperty(JSCompiler_renameProperty("__hasRegisterFinished",proto))){this._registered();// backstop in case the `_registered` implementation does not set this
proto.__hasRegisterFinished=!0}babelHelpers.get(babelHelpers.getPrototypeOf(LegacyElement.prototype),"_initializeProperties",this).call(this);this.root=/** @type {HTMLElement} */this;this.created();// Pull all attribute values 1x if `legacyNoObservedAttributes` is set.
...
this._applyListeners()}}},{key:"_takeAttributes",value:function _takeAttributes(){for(var a=this.attributes,i=0,l=a.length,attr;i<l;i++){attr=a[i];this.__attributeReaction(attr.name,null,attr.value)}}/**
...
if(Array.isArray(args)&&1===args.length&&Array.isArray(args[0])){args=args[0]}switch(level){case"log":case"warn":case"error":(_console=console)[level].apply(_console,babelHelpers.toConsumableArray(args));}}/**
     ...
     *   logging.
     * @override
     */},{key:"_logf",value:function _logf(methodName){for(var _len4=arguments.length,args=Array(1<_len4?_len4-1:0),_key4=1;_key4<_len4;_key4++){args[_key4-1]=arguments[_key4]}return["[%s::%s]",this.is,methodName].concat(args)}},{key:"domHost",get:function get(){var root=(0,_wrap.wrap)(this).getRootNode();return babelHelpers.instanceof(root,DocumentFragment)?/** @type {ShadowRoot} */root.host:root}}],[{key:"importMeta",get:function get(){return this.prototype.importMeta}},{key:"observedAttributes",get:function get(){if(_settings.legacyNoObservedAttributes&&!this.prototype._legacyForceObservedAttributes){// Ensure this element is property registered with the telemetry system.
if(!this.hasOwnProperty(JSCompiler_renameProperty("__observedAttributes",this))){this.__observedAttributes=[];(0,_telemetry.register)(this.prototype)}return this.__observedAttributes}else{return observedAttributesGetter.call(this).concat(DISABLED_ATTR)}}}]);return LegacyElement}(legacyElementBase);// Note, the DirMixin does nothing if css is built so avoid including it
// in that case.
/**
   * @constructor
   * @extends {GesturesElement}
   * @private
   */LegacyElement.prototype.is="";return LegacyElement});_exports.LegacyElementMixin=LegacyElementMixin});