define(["exports","../utils/boot.js","../utils/settings.js","../utils/mixin.js","../utils/style-gather.js","../utils/resolve-url.js","../elements/dom-module.js","./property-effects.js","./properties-mixin.js","../utils/wrap.js"],function(_exports,_boot,_settings,_mixin,_styleGather,_resolveUrl2,_domModule,_propertyEffects,_propertiesMixin,_wrap){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.updateStyles=_exports.ElementMixin=_exports.builtCSS=_exports.version=void 0;/**
 * @fileoverview
 ...
 */var version="3.4.1";_exports.version=version;var builtCSS=window.ShadyCSS&&window.ShadyCSS.cssBuild;/**
 ...
 */_exports.builtCSS=builtCSS;var ElementMixin=(0,_mixin.dedupingMixin)(function(base){/**
   * @constructor
...
for(var templateStyleIndex=0,i=0;i<stylesWithImports.length;i++){var _s=stylesWithImports[i],templateStyle=templateStyles[templateStyleIndex];// if the style is not in this template, it's been "included" and
...
if(_settings.strictTemplatePolicy&&!template){throw new Error("strictTemplatePolicy: expecting dom-module or null template for ".concat(is))}}return template}/**
   * @polymer
   * @mixinClass
   * @unrestricted
...
var template=/** @type {PolymerElementConstructor} */this.template;if(template){if("string"===typeof template){console.error("template getter must return HTMLTemplateElement");template=null}else if(!_settings.legacyOptimizations){template=template.cloneNode(!0)}}/** @override */this.prototype._template=template}/**
     ...
     * @protected
     * @nocollapse
     */},{key:"createObservers",value:function createObservers(observers,dynamicFns){for(var proto=this.prototype,i=0;i<observers.length;i++){proto._createMethodObserver(observers[i],dynamicFns)}}/**
...
Object.getPrototypeOf(/** @type {PolymerElementConstructor}*/this.prototype).constructor.template}return this._template}/**
     ...
     * @nocollapse
     */},{key:"importPath",get:function get(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_importPath",this))){var meta=this.importMeta;if(meta){this._importPath=(0,_resolveUrl2.pathFromUrl)(meta.url)}else{var module=_domModule.DomModule.import(/** @type {PolymerElementConstructor} */this.is);this._importPath=module&&module.assetpath||Object.getPrototypeOf(/** @type {PolymerElementConstructor}*/this.prototype).constructor.importPath}}return this._importPath}}]);function PolymerElement(){var _this;babelHelpers.classCallCheck(this,PolymerElement);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PolymerElement).call(this));/** @type {HTMLTemplateElement} */_this._template;/** @type {string} */_this._importPath;/** @type {string} */_this.rootPath;/** @type {string} */_this.importPath;/** @type {StampedTemplate | HTMLElement | ShadowRoot} */_this.root;/** @type {!Object<string, !Element>} */_this.$;return _this}/**
...
var p$=propertyDefaults(this.constructor);if(!p$){return}for(var p in p$){var info=p$[p];if(this._canApplyPropertyDefault(p)){var value="function"==typeof info.value?info.value.call(this):info.value;// Set via `_setProperty` if there is an accessor, to enable
...
babelHelpers.get(babelHelpers.getPrototypeOf(PolymerElement.prototype),"_readyClients",this).call(this)}/**
     ...
     */},{key:"_attachDom",value:function _attachDom(dom){var n=(0,_wrap.wrap)(this);if(n.attachShadow){if(dom){if(!n.shadowRoot){n.attachShadow({mode:"open",shadyUpgradeFragment:dom});n.shadowRoot.appendChild(dom);// When `adoptedStyleSheets` is supported a stylesheet is made
...
"PolymerElement can create dom as children instead of in "+"ShadowDOM by setting `this.root = this;` before `ready`.")}}/**
     ...
     */},{key:"resolveUrl",value:function resolveUrl(url,base){if(!base&&this.importPath){base=(0,_resolveUrl2.resolveUrl)(this.importPath)}return(0,_resolveUrl2.resolveUrl)(url,base)}/**
     ...
     * @suppress {missingProperties} Interfaces in closure do not inherit statics, but classes do
     * @nocollapse
     */}],[{key:"_processStyleText",value:function _processStyleText(cssText,baseURI){return(0,_resolveUrl2.resolveCss)(cssText,baseURI)}/**
 ...
 * @return {void}
 */_exports.ElementMixin=ElementMixin;var updateStyles=function updateStyles(props){if(window.ShadyCSS){window.ShadyCSS.styleDocument(props)}};_exports.updateStyles=updateStyles});