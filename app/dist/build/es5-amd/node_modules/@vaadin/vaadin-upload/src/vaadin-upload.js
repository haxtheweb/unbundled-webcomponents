...
this.__resetMouseCanceller();this._onAddFilesClick()}},{key:"__resetMouseCanceller",value:function __resetMouseCanceller(){(0,_gestures.resetMouseCanceller)()}},{key:"_onAddFilesClick",value:function _onAddFilesClick(){if(this.maxFilesReached){return}this.$.fileInput.value="";this.$.fileInput.click()}},{key:"_onFileInputChange",value:function _onFileInputChange(event){this._addFiles(event.target.files)}},{key:"_onFileStart",value:function _onFileStart(event){this._uploadFile(event.detail.file)}},{key:"_onFileRetry",value:function _onFileRetry(event){this._retryFileUpload(event.detail.file)}},{key:"_onFileAbort",value:function _onFileAbort(event){this._abortFileUpload(event.detail.file)}},{key:"_onFileRemove",value:function _onFileRemove(event){this._removeFile(event.detail.file)}},{key:"_dragoverChanged",value:function _dragoverChanged(dragover){dragover?this.setAttribute("dragover",dragover):this.removeAttribute("dragover")}},{key:"_dragoverValidChanged",value:function _dragoverValidChanged(dragoverValid){dragoverValid?this.setAttribute("dragover-valid",dragoverValid):this.removeAttribute("dragover-valid")}},{key:"_i18nPlural",value:function _i18nPlural(value,plural){return 1==value?plural.one:plural.many}},{key:"_isMultiple",value:function _isMultiple(maxFiles){return 1!=maxFiles}/**
  ...
  * @param {Object} detail.xhr the xhr
  * @param {Object} detail.file the file being uploaded
  */}],[{key:"template",get:function get(){return(0,_htmlTag.html)(_templateObject_98cff6d0aa6b11ea8c71fd347a4aa284())}},{key:"is",get:function get(){return"vaadin-upload"}},{key:"version",get:function get(){return"4.3.0"}},{key:"properties",get:function get(){return{/**
