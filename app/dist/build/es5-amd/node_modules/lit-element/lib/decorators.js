define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.property=property;_exports.internalProperty=internalProperty;_exports.query=query;_exports.queryAsync=queryAsync;_exports.queryAll=queryAll;_exports.eventOptions=eventOptions;_exports.queryAssignedNodes=queryAssignedNodes;_exports.customElement=void 0;/**
 * @license
...
name){var descriptor={get:function get(){return this.renderRoot.querySelector(selector)},enumerable:!0,configurable:!0};return name!==void 0?legacyQuery(descriptor,protoOrDescriptor,name):standardQuery(descriptor,protoOrDescriptor)}}// Note, in the future, we may extend this decorator to support the use case
...
// the others
return function(protoOrDescriptor,name){return name!==void 0?legacyEventOptions(options,protoOrDescriptor,name):standardEventOptions(options,protoOrDescriptor)}}/**
 * A property decorator that converts a class property into a getter that
 * returns the `assignedNodes` of the given named `slot`. Note, the type of
 * this property should be annotated as `NodeListOf<HTMLElement>`.
 *
 */function queryAssignedNodes(){var slotName=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"",flatten=1<arguments.length&&arguments[1]!==void 0?arguments[1]:!1;return function(protoOrDescriptor,// tslint:disable-next-line:no-any decorator
name){var descriptor={get:function get(){var selector="slot".concat(slotName?"[name=".concat(slotName,"]"):""),slot=this.renderRoot.querySelector(selector);return slot&&slot.assignedNodes({flatten:flatten})},enumerable:!0,configurable:!0};return name!==void 0?legacyQuery(descriptor,protoOrDescriptor,name):standardQuery(descriptor,protoOrDescriptor)}}});