...
},{key:"pathFromUrl",value:function pathFromUrl(url){return url.substring(0,url.lastIndexOf("/")+1)}}]);return DynamicImportRegistry}(/*#__PURE__*/babelHelpers.wrapNativeSuper(HTMLElement));_exports.DynamicImportRegistry=DynamicImportRegistry;window.customElements.define(DynamicImportRegistry.tag,DynamicImportRegistry)});