define(["exports","../../../lit-element/lit-element.js","./simple-fields-fieldset.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/iron-icons/iron-icons.js","./simple-fields-array-item.js"],(function(_exports,_litElement,_simpleFieldsFieldset,_paperButton,_ironIcon,_ironIcons,_simpleFieldsArrayItem){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimpleFieldsArray=void 0;class SimpleFieldsArray extends _simpleFieldsFieldset.SimpleFieldsFieldset{static get tag(){return"simple-fields-array"}static get styles(){return[...super.styles,_litElement.css`
      ...
      `]}static get properties(){return{...super.properties,count:{type:Number},expanded:{type:Boolean}}}render(){return _litElement.html`
      <fieldset>
