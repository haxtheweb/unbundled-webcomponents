define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../a11y-collapse/lib/a11y-collapse-group.js","../../a11y-collapse/a11y-collapse.js","../../hax-body-behaviors/lib/HAXFields.js"],(function(_exports,_require,_litElement,_utils,_a11yCollapseGroup,_a11yCollapse,_HAXFields){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxTray=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxTray extends((0,_utils.winEventsElement)(_litElement.LitElement)){static get tag(){return"hax-tray"}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated"},this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!0,this.canRedo=!0,this.elementAlign="right",this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.__setup=!1,setTimeout(()=>{new Promise((res,rej)=>_require.default(["./hax-tray-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icon/iron-icon.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/editor-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/device-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/hardware-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/communication-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/social-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/image-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/av-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/maps-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/places-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../md-extra-icons/md-extra-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../hax-iconset/hax-iconset.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../lrn-icons/lrn-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-tray-upload.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../simple-fields/simple-fields.js"],res,rej)),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this)),new Promise((res,rej)=>_require.default(["./hax-gizmo-browser.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-app-browser.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-blox-browser.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-stax-browser.js"],res,rej))},0)}_haxStorePropertyUpdated(e){e.detail&&void 0!==e.detail.value&&e.detail.property&&("globalPreferences"!==e.detail.property&&"activeGizmo"!==e.detail.property&&"activeNode"!==e.detail.property||(this[e.detail.property]={}),this[e.detail.property]=e.detail.value)}static get styles(){return[_litElement.css`
        :host {
